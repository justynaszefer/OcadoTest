...
//    Objects
    ...
    @FindBy (className = "productCount")
    private  WebElement productCountLocator;

//
    public WebElement getProductCountLocator() {
        return productCountLocator;
    }

    public WebElement getBasketSummaryCountLocator() {
        return basketSummaryCountLocator;
    }
    ...
    public ShopPage find_promo(int promoType) {
    ...
    public ShopPage add_to_the_basket(int promoType,String productNum) {
        switch(promoType) {
            case 0:
    ...
    public double basket_summary_savings() {
        ...
        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.id("basketSummaryCount"), new PropertyReader().readProperty("productNum2")));
